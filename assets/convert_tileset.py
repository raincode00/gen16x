...
print("};")
for y0 in range(0, im.size[1]//tile_size):
	for x0 in range(0, im.size[0]//tile_size):
		tile = []
		for y2 in range(0, tile_size):
			for x2 in range(0, tile_size):
				x = (x0)*tile_size + x2
				y = y0*tile_size + y2
